...
export default function CreateProjectModal({ isOpen, onClose, onSave, initialData = null, isEditing = false }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-white rounded-xl shadow-2xl max-w-sm w-full max-h-[90dvh] overflow-y-auto transform transition-all animate-slideUp">
        {/* Header */}
        <div className="relative px-4 py-3 border-b border-gray-100">
          ...
          <button
            ...
            className="absolute right-3 top-3 p-3 hover:bg-gray-50 rounded-lg transition-colors disabled:opacity-50 text-gray-400 hover:text-gray-600 min-w-[44px] min-h-[44px] flex items-center justify-center"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
