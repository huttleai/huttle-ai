          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-[#01BAD2]">This offer is closed</p>
              </div>
            </div>
            ...
            <p className="text-center text-xs font-semibold text-zinc-400 mt-5">
              Essentials and Pro include a 7-day trial. A card is required to start.
            </p>
          </motion.div>
        </motion.div>
      )}
