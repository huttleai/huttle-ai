...
export const FacebookIconMono = ({ className = "w-5 h-5" }) => (
...
export const YouTubeIconMono = ({ className = "w-5 h-5" }) => (
  <Youtube className={className} />
);

export const LinkedInIconMono = ({ className = "w-5 h-5" }) => (
  <Linkedin className={className} />
);

// Colored SVG icons (for specific brand use cases only)
export const InstagramIcon = ({ className = "w-5 h-5", monochrome = false }) => {
  if (monochrome) return <InstagramIconMono className={className} />;
...
export const FacebookIcon = ({ className = "w-5 h-5", monochrome = false }) => {
  if (monochrome) return <FacebookIconMono className={className} />;
...
export const TikTokIcon = ({ className = "w-5 h-5", monochrome = false }) => {
  if (monochrome) return <TikTokIconMono className={className} />;
...
export const TwitterXIcon = ({ className = "w-5 h-5", monochrome = false }) => {
  if (monochrome) return <TwitterXIconMono className={className} />;
...
export const YouTubeIcon = ({ className = "w-5 h-5", monochrome = false }) => {
  if (monochrome) return <YouTubeIconMono className={className} />;
...
export const LinkedInIcon = ({ className = "w-5 h-5", monochrome = false }) => {
  if (monochrome) return <LinkedInIconMono className={className} />;
