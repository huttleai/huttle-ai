// Actual Social Media Platform SVG Icons
...
export const getPlatformColor = (platform) => {
  ...
  if (platformLower.includes('instagram')) return { bg: 'bg-pink-500', text: 'text-pink-500' };
  if (platformLower.includes('facebook')) return { bg: 'bg-blue-600', text: 'text-blue-600' };
  if (platformLower.includes('tiktok')) return { bg: 'bg-black', text: 'text-black' };
  if (platformLower.includes('x') || platformLower.includes('twitter')) return { bg: 'bg-black', text: 'text-black' };
  if (platformLower.includes('linkedin')) return { bg: 'bg-blue-700', text: 'text-blue-700' };
  if (platformLower.includes('youtube')) return { bg: 'bg-red-600', text: 'text-red-600' };
