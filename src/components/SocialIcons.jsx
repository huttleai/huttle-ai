// Actual Social Media Platform SVG Icons with Brand Colors
...
export const TwitterXIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="#000000">
...
export const getPlatformIcon = (platform, className) => {
...
// Deprecated as background colors are removed, but kept for legacy/badge support if needed elsewhere
export const getPlatformColor = (platform) => {
  const platformLower = platform?.toLowerCase() || '';
  
  if (platformLower.includes('instagram')) return { bg: 'bg-white', text: 'text-gray-900', border: 'border-pink-200' };
  if (platformLower.includes('facebook')) return { bg: 'bg-white', text: 'text-gray-900', border: 'border-blue-200' };
  if (platformLower.includes('tiktok')) return { bg: 'bg-white', text: 'text-gray-900', border: 'border-gray-200' };
  if (platformLower.includes('x') || platformLower.includes('twitter')) return { bg: 'bg-white', text: 'text-gray-900', border: 'border-gray-200' };
  if (platformLower.includes('youtube')) return { bg: 'bg-white', text: 'text-gray-900', border: 'border-red-200' };
  if (platformLower.includes('linkedin')) return { bg: 'bg-white', text: 'text-gray-900', border: 'border-blue-300' };
